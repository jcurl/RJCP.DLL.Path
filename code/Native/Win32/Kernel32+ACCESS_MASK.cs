namespace RJCP.IO.Native.Win32
{
    ...
    /// <content>Contains the <see cref="ACCESS_MASK"/> nested type.</content>
    internal partial class Kernel32
    {
        ...
        /// </remarks>
        public readonly struct ACCESS_MASK : IFormattable
        {
            /// <summary>
            /// Bits 28-31.
            /// </summary>
            ...
            {
                /// <summary>
                /// It is used to indicate access to a system access control list (SACL). This type of access requires
                /// the calling process to have the SE_SECURITY_NAME (Manage auditing and security log) privilege. If
                /// this flag is set in the access mask of an audit access ACE (successful or unsuccessful access), the
                /// SACL access will be audited.
                /// </summary>
            ...
            public enum StandardRight : uint
            {
                ...
                /// <summary>
                /// Read access to the owner, group, and discretionary access control list (DACL) of the security
                /// descriptor.
                /// </summary>
            ...
            /// <summary>
            /// The following are the generic access rights for a desktop object contained in the interactive window
            /// station of the user's logon session.
            /// </summary>
            [Flags]
            ...
            /// <summary>
            /// Generic access rights for the interactive window station object, which is the window station assigned to
            ...
            /// <summary>
            /// Generic access rights for a non-interactive window station object. The system assigns non-interactive
            ...
            public enum WindowStationSpecificRight : uint
            {
                ...
                /// <summary>
                /// Required to successfully call the ExitWindows or ExitWindowsEx function Window stations can be
                /// shared by users and this access type can prevent other users of a window station from logging off
                /// the window station owner.
                /// </summary>
                WINSTA_EXITWINDOWS = 0x00000040,

                /// <summary>
                /// Required to read the attributes of a window station object. This attribute includes color settings
                /// and other global window station properties.
                /// </summary>
                ...
                /// <summary>
                /// Required to modify the attributes of a window station object. The attributes include color settings
                /// and other global window station properties.
                /// </summary>
            ...
            /// </summary>
            public GenericRight GenericRights => (GenericRight)(Value & GenericRightsMask);

            /// <summary>
            /// Gets the special rights of this value.
            /// </summary>
            public SpecialRight SpecialRights => (SpecialRight)(Value & SpecialRightsMask);

            /// <summary>
            /// Gets the standard rights of this value.
            /// </summary>
            public StandardRight StandardRights => (StandardRight)(Value & StandardRightsMask);

            /// <summary>
            /// Gets the specific rights of this value.
            /// </summary>
            public SpecificRight SpecificRights => (SpecificRight)(Value & SpecificRightsMask);

            /// <summary>
            /// Gets the specific rights of this value for desktops.
            /// </summary>
            public DesktopSpecificRight DesktopSpecificRights => (DesktopSpecificRight)SpecificRights;
            ...
            public InteractiveWindowStationGenericRight InteractiveWindowStationGenericRights =>
                (InteractiveWindowStationGenericRight)GenericRights;

            /// <summary>
            /// Gets the generic rights of this value for non-interactive window stations.
            /// </summary>
            public NonInteractiveWindowStationGenericRight NonInteractiveWindowStationGenericRights =>
                (NonInteractiveWindowStationGenericRight)GenericRights;

            /// <summary>
            /// Gets the specific rights of this value for window stations.
            /// </summary>
            public WindowStationSpecificRight WindowStationSpecificRights => (WindowStationSpecificRight)SpecificRights;
