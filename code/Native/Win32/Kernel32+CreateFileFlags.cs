namespace RJCP.IO.Native.Win32
{
    ...
    internal partial class Kernel32
    {
        ...
        public enum CreateFileFlags : uint
        {
            ...
            /// calling process overrides file security checks when the process has SE_BACKUP_NAME and SE_RESTORE_NAME
            /// privileges. For more information, see Changing Privileges in a Token. You must set this flag to obtain a
            /// handle to a directory. A directory handle can be passed to some functions instead of a file handle. For
            ...
            /// handle and any other open or duplicated handles. If there are existing open handles to a file, the call
            /// fails unless they were all opened with the <see cref="FileShare.FILE_SHARE_DELETE"/> share mode.
            /// Subsequent open requests for the file fail, unless the <see cref="FileShare.FILE_SHARE_DELETE"/> share
            /// mode is specified.
            /// </summary>
            ...
            /// affect hard disk caching or memory mapped files. There are strict requirements for successfully working
            /// with files opened with CreateFile using the <see cref="FILE_FLAG_NO_BUFFERING"/> flag.
            /// </summary>
            ...
            /// <summary>
            /// Normal reparse point processing will not occur; CreateFile will attempt to open the reparse point. When
            /// a file is opened, a file handle is returned, whether or not the filter that controls the reparse point
            /// is operational. This flag cannot be used with the <see cref="CreationDisposition.CREATE_ALWAYS"/> flag.
            /// If the file is not a reparse point, then this flag is ignored. For more information, see the Remarks
            /// section.
            /// </summary>
            ...
            /// completed on this handle, the event specified in the OVERLAPPED structure will be set to the signaled
            /// state. If this flag is specified, the file can be used for simultaneous read and write operations. If
            /// this flag is not specified, then I/O operations are serialized, even if the calls to the read and write
            /// functions specify an OVERLAPPED structure.For information about considerations when using a file handle
            /// created with this flag, see the Synchronous and Asynchronous I/O Handles section of this topic.
            /// </summary>
            ...
            /// <summary>
            /// Access is intended to be random. The system can use this as a hint to optimize file caching. This flag
            /// has no effect if the file system does not support cached I/O and <see cref="FILE_FLAG_NO_BUFFERING"/>.
            ...
            /// per-session devices (such as a redirected USB device) cannot be opened by processes running in session
            /// 0. This flag has no effect for callers not in session 0. This flag is supported only on server editions
            /// of Windows.
            /// </summary>
            ...
            /// file caching. This flag should not be used if read-behind (that is, reverse scans) will be used. This
            /// flag has no effect if the file system does not support cached I/O and
            /// <see cref="FILE_FLAG_NO_BUFFERING"/>. For more information, see the Caching Behavior section of this
            /// topic.
            /// </summary>
            FILE_FLAG_SEQUENTIAL_SCAN = 0x08000000,

            /// <summary>
            /// Write operations will not go through any intermediate cache, they will go directly to disk. For
            /// additional information, see the Caching Behavior section of this topic.
            /// </summary>
            ...
            /// specify this flag, all aspects of the client's security context are available. This allows the client to
            /// limit the groups and privileges that a server can use while impersonating the client.
            /// </summary>
            ...
            /// specified along with the <see cref="SECURITY_SQOS_PRESENT"/> flag.
            /// </summary>
