namespace RJCP.IO.Files.Exe.Win32
{
    ...
    internal static partial class PEHeader
    {
        ...
        public enum IMAGE_FILE_Characteristics : ushort
        {
            ...
            /// is not available, the loader reports an error. The default behavior of the linker is to strip base
            ...
            /// <summary>
            /// COFF symbol table entries for local symbols have been removed. This flag is deprecated and should be
            /// zero.
            /// </summary>
            LOCAL_SYMS_STRIPPED = 0x0008,

            /// <summary>
            /// Obsolete. Aggressively trim working set. This flag is deprecated for Windows 2000 and later and must be
            /// zero.
            /// </summary>
